...
# ADAPTER: Choose from 'fenrirealm', 'readhive', 'boti-translations', '69shuba', 'wetriedtls'
ADAPTER_NAME = "wetriedtls"

# START: The first chapter URL to start scraping from
START = "https://wetriedtls.com/series/regression-is-too-much/chapter-0"
