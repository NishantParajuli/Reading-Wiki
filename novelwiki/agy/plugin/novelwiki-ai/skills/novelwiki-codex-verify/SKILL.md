...
Read the manifest, chapter chunks, roster, draft extraction, draft summary, and schema. Check
every draft claim against the chapter; remove unsupported/duplicate/future claims and add missed
supported facts, relationships, events, aliases, and identity reveals. Every material claim needs
one or more supplied chunk IDs. Write corrected `output/extraction.json`, corrected
